...
<html lang="vi">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:w…0;500;600;700&family=Courier+Prime:wght@400;700&display=swap" rel="stylesheet">
        <style>
            :root{
                --navy:#1B2A3D;
                --navy-light:#233c56;
            ...
            *{
            ...
            .menu-item:hover{
                ...
                box-shadow:0 4px 14px rgba(169,113,63,.15);
            ...
            @media print{
                .sidebar,.topbar,.left,.receipt::before,.receipt::after,.receipt-actions,.pay-methods{
